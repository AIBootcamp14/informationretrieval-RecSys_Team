"""
Hybrid Search Alpha 파라미터 최적화

BM25와 Dense Retrieval의 가중치를 조정하여 최적 성능 찾기
"""
...
def main():
    ...
    print(f"\n다음 단계:")
    print(f"  1. 각 파일을 Leaderboard에 제출")
    print(f"  2. 최고 점수를 낸 alpha 값 확인")
    print(f"  3. 해당 alpha 값으로 다음 실험 진행")
    print(f"{'='*80}\n")
